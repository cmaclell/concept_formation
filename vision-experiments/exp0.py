...
def exp0_nn(general_config, model_config, data_config, dataset_tr, dataset_te, verbose):
...
def exp0_cobweb(general_config, model_config, data_config, dataset_tr, dataset_te, verbose):
