...
def experiment_2_nn(general_config, model_config, data_config, dataset_tr, dataset_te, verbose):
...
def experiment_2_cobweb(general_config, model_config, data_config, dataset_tr, dataset_te, verbose):
